 ...
 * ============================================================ */
!function(c){c.fn.bootstrapSwitch=function(e){var k={init:function(){return this.each(function(){var a=c(this),b,d,f,h,e=a.closest("form"),g="",k=a.attr("class"),l;d="Active";h="Deactive";var m=b=!1;c.each(["switch-mini","switch-small","switch-large"],function(a,b){0<=k.indexOf(b)&&(g=b)});a.addClass("has-switch");void 0!==a.data("no")&&(f="switch-"+a.data("no"));void 0!==a.data("on-label")&&(d=a.data("on-label"));void 0!==a.data("off-label")&&(h=a.data("off-label"));void 0!==a.data("label-icon")&&(b=a.data("label-icon"));
