...
;(function(c,k,l,j){var h=function(a,b){arguments.length&&this._init(a,b)};h.prototype={defaults:{element:".wizard-step",navLabelElement:".wizard-label",navContainerClass:"wizard-nav",buttonContainerClass:"form-actions btn-toolbar",defaultButtonClass:"btn btn-danger",responsiveNextButtonClass:"responsive-next-btn btn btn-danger",responsivePrevButtonClass:"btn btn-danger responsive-prev-btn ",submitButtonClass:"my_submit",responsiveNextButtonLabel:'<i class="glyphicon glyphicon-arrow-right"></i>',responsivePrevButtonLabel:'<i class="glyphicon glyphicon-arrow-left"></i>',
