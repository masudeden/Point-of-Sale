...
echo $links; 
 echo form_open('pos_users/delete_selected_pos_users');?>
...
if($count!=0){
      if($_SESSION['admin']==2){?><table >
        ...
        </td> <td style="width: 150;margin-left: 150px"><?php if($b_row->user_active==0){ ?><a href="<?php echo base_url() ?>index.php/pos_users/to_deactivate_user/<?php echo $erow->id ?>">Deactivate</a> <?php } else{ ?><a href="<?php echo base_url() ?>index.php/pos_users/to_activate_user/<?php echo $erow->id ?>"> Activate</a> <?php } ?></td>
        <td style="width: 100px"><a href="<?php echo base_url() ?>index.php/pos_users/edit_pos_users_details/<?php echo $erow->id ?>"><?php echo $this->lang->line('edit') ?></a><td><td style="width: 100px"><a href="<?php echo base_url() ?>index.php/pos_users_permissions/edit_pos_users_permission/<?php echo $erow->id ?>"><?php echo $this->lang->line('edit_permission') ?></a></td>
        <td><a href=" <?php echo base_url() ?>index.php/pos_users/delete_pos_users_details_in_admin/<?php echo $erow->id ?>"><?php echo $this->lang->line('delete') ?></a></td>
    </tr><?php }}}?></table>
