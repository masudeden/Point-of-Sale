...
<script type="text/javascript">
     $(document).ready( function () {
         $('#add_new_brand').click(function() { 
                <?php if($_SESSION['taxes_area_per']['add']==1){ ?>
                var inputs = $('#add_brand').serialize();
                      $.ajax ({
                            url: "<?php echo base_url('index.php/taxes_area/add_taxes_area')?>",
                            data: inputs,
                            type:'POST',
                            complete: function(response) {
                                if(response['responseText']=='TRUE'){
                                      $.bootstrapGrowl('<?php echo $this->lang->line('brand').' '.$this->lang->line('added');?>', { type: "success" });                                                                                  
                                       ...
                                       posnic_taxes_area_lists();
                                    }else  if(response['responseText']=='ALREADY'){
                                           $.bootstrapGrowl($('#taxes_area').val()+' <?php echo $this->lang->line('brand').' '.$this->lang->line('is_already_added');?>', { type: "warning" });                           
         ...
         $('#update_taxes_area').click(function() { 
                <?php if($_SESSION['taxes_area_per']['edit']==1){ ?>
                var inputs = $('#parsley_reg').serialize();
                      $.ajax ({
                            url: "<?php echo base_url('index.php/taxes_area/update_taxes_area')?>",
                            data: inputs,
                            type:'POST',
                            complete: function(response) {
                                  if(response['responseText']=='TRUE'){
...
function posnic_taxes_area_lists(){
      ...
      $('#posnic_add_taxes_area').removeAttr("disabled");
      $('#taxes_area_lists').attr("disabled",'disabled');
}
function clear_add_taxes_area(){
    ...
    <div class="container">
            <div class="row">
                <div class="col col-lg-7">
                        <a href="javascript:posnic_add_new()" id="posnic_add_taxes_area" class="btn btn-success" ><i class="icon icon-user"></i> <?php echo $this->lang->line('addnew') ?></a>  
                        ...
                        <a href="javascript:posnic_taxes_area_lists()" class="btn btn-success" id="taxes_area_lists"><i class="icon icon-list"></i> <?php echo $this->lang->line('taxes_area') ?></a>
                </div>
            </div>
    </div>
</nav>
...
<section class="container clearfix main_section">
        <div id="main_content_outer" class="clearfix">
            <div id="main_content">
                    ...
                    echo form_open('taxes_area/taxes_area_manage',$form) ?>
                        <div class="row">
                            <div class="col-sm-12" id="user_list"><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                            <h4 class="panel-title"><?php echo $this->lang->line('taxes_area') ?></h4>                                                                               
                                    </div>
                                    <table id="dt_table_tools" class="table-striped table-condensed" style="width: 100%"><thead>
                                        <tr>
                                          <th>Id</th>
                                          <th ><?php echo $this->lang->line('select') ?></th>
                                          <th ><?php echo $this->lang->line('taxes_area') ?></th>
...
<section id="add_brand_form" class="container clearfix main_section">
     <?php   $form =array('id'=>'add_brand',
       ...
       echo form_open_multipart('taxes_area/add_pos_taxes_area_details/',$form);?>
        <div id="main_content_outer" class="clearfix">
           <div id="main_content">
                 <div class="row">
                                               ...
                                               <div class="col col-lg-10">
                                                    <div class="form_sep">
                                                         <label for="taxes_area" class="req"><?php echo $this->lang->line('taxes_area') ?></label>                                                                                                       
                                                           <?php $taxes_area=array('name'=>'taxes_area',
                    ...
                    <div class="row">
                                <div class="col-lg-4"></div>
                                  <div class="col col-lg-4 text-center"><br><br>
                                      ...
                                      <a href="javascript:clear_add_taxes_area()" name="clear" id="clear_user" class="btn btn-warning"><i class="icon icon-list"> </i> <?php echo $this->lang->line('clear') ?></a>
                                  </div>
                              </div>
                </div>
          </div>
...
<section id="edit_brand_form" class="container clearfix main_section">
     <?php   $form =array('id'=>'parsley_reg',
                          'runat'=>'server',
                          'class'=>'form-horizontal');
       echo form_open_multipart('taxes_area/upadate_pos_taxes_area_details/',$form);?>
        <div id="main_content_outer" class="clearfix">
           <div id="main_content">
                <div class="row">
                     <div class="col-lg-4"></div>
                   ...
                   <div class="row">
                        <div class="col-lg-4"></div>
                      <div class="col col-lg-4 text-center"><br><br>
                          <button id="update_taxes_area"  type="submit" name="save" class="btn btn-success"><i class="icon icon-save"> </i> <?php echo $this->lang->line('update') ?></button>
