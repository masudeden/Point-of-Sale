...
echo form_open('items_setting/update');
   ...
   echo "<tr><td>";echo form_label($this->lang->line('min_qty'));echo "</td><td>";echo form_input('min_qty','id=min_qty' ); echo "</td></tr>";
   echo "<tr><td>";echo form_label($this->lang->line('max_qty'));echo "</td><td>";echo form_input('max_qty','id=min_qty' ); echo "</td></tr>";
