...
, null,  null, 
 							...
 							{	"sName": "ID",
                   						...
                   						"fnRender": function (oObj) {
                   							if(oObj.aData[9]==0){
                                                                            ...
                                                                            return '<span data-toggle="tooltip" class="label label-success hint--top data-hint="<?php echo $this->lang->line('active') ?>" ><?php echo $this->lang->line('approved') ?></span>';
                                                                        }
								},
 							...
 							{	"sName": "ID1",
                   						...
                   						"fnRender": function (oObj) {
                                                                if(oObj.aData[9]==0){
                                                                     return '<a href=javascript:posnic_active("'+oObj.aData[0]+'") ><span data-toggle="tooltip" class="label label-success hint--top hint--success" data-hint="<?php echo $this->lang->line('active') ?>"><i class="icon-play"></i></span></a>&nbsp<a href=javascript:view_function("'+oObj.aData[0]+'") ><span data-toggle="tooltip" class="label label-info hint--top hint--info" data-hint="EDIT"><i class="icon-edit"></i></span></a>'+"&nbsp;</a>";            	
                        
								 }else if(oObj.aData[9]==1){
                                                                     return '<a href=javascript:posnic_deactive("'+oObj.aData[0]+'")><span data-toggle="tooltip" class="label label-warning hint--top hint--warning" data-hint="<?php echo $this->lang->line('deactive') ?>"><i class="icon-pause"></i></span></a>&nbsp<a href=javascript:view_function("'+oObj.aData[0]+'")  ><span data-toggle="tooltip" class="label label-info hint--top hint--info" data-hint="EDIT"><i class="icon-edit"></i></span></a>'+"&nbsp; </a>";
                                                                }
                                                                },
 ...
 function user_function(guid){
    <?php if($_SESSION['purchase_order_per']['delete']==1){ ?>
             ...
             if(result){
            $.ajax({
                url: '<?php echo base_url() ?>/index.php/purchase_order_approval/delete',
                type: "POST",
                data: {
                    guid: guid
...
?>
            ...
            function posnic_deactive(guid){
                $.ajax({
                url: '<?php echo base_url() ?>index.php/purchase_order_approval/deactive',
                type: "POST",
                data: {
                    guid: guid
            ...
            function posnic_active(guid){
                           $.ajax({
                url: '<?php echo base_url() ?>index.php/purchase_order_approval/active',
                type: "POST",
                data: {
                    guid: guid
         ...
         $('#save_clear').hide();
           $('#loading').modal('show');
                        ...
                        <?php if($_SESSION['purchase_order_per']['edit']==1){ ?>
                            $.ajax({                                      
                             url: "<?php echo base_url() ?>index.php/purchase_order_approval/get_purchase_order/"+guid,                      
                             data: "", 
                             dataType: 'json',               
