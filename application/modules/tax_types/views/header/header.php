...
<script type="text/javascript" charset="utf-8">
    ...
    <?php if($this->session->userdata['tax_types_per']['delete']==1){ ?>
            ...
            $.ajax({
                ...
                {
                    if(response){
                           $.bootstrapGrowl('<?php echo $this->lang->line('tax_types') ?> '+$('#name_'+guid).val()+' <?php echo $this->lang->line('deleted');?>', { type: "error" });
           ...
           $.bootstrapGrowl('<?php echo $this->lang->line('You Have NO Permission To Delete')." ".$this->lang->line('tax_types');?>', { type: "error" });                       
   <?php }
?>
                        }
