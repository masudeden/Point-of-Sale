...
<script type="text/javascript">
     $(document).ready( function () {
         $('#add_new_brand').click(function() { 
                <?php if($_SESSION['tax_types_per']['add']==1){ ?>
                                ...
                                if(response['responseText']=='TRUE'){
                                      $.bootstrapGrowl('<?php echo $this->lang->line('brand').' '.$this->lang->line('added');?>', { type: "success" });                                                                                  
                                       ...
                                       posnic_tax_types_lists();
                                           ...
                                           $.bootstrapGrowl($('#tax_types').val()+' <?php echo $this->lang->line('brand').' '.$this->lang->line('is_already_added');?>', { type: "warning" });                           
         ...
         $('#update_tax_types').click(function() { 
                <?php if($_SESSION['tax_types_per']['edit']==1){ ?>
                var inputs = $('#parsley_reg').serialize();
                      $.ajax ({
                            url: "<?php echo base_url('index.php/tax_types/update_tax_types')?>",
                            data: inputs,
                            type:'POST',
                            complete: function(response) {
                                  if(response['responseText']=='TRUE'){
...
function posnic_tax_types_lists(){
      ...
      $('#posnic_add_tax_types').removeAttr("disabled");
      $('#tax_types_lists').attr("disabled",'disabled');
}
    ...
    <div class="container">
            <div class="row">
                <div class="col col-lg-7">
                        <a href="javascript:posnic_add_new()" id="posnic_add_tax_types" class="btn btn-success" ><i class="icon icon-user"></i> <?php echo $this->lang->line('addnew') ?></a>  
                        ...
                        <a href="javascript:posnic_tax_types_lists()" class="btn btn-success" id="tax_types_lists"><i class="icon icon-list"></i> <?php echo $this->lang->line('tax_types') ?></a>
                </div>
            </div>
    </div>
</nav>
...
<section class="container clearfix main_section">
        <div id="main_content_outer" class="clearfix">
            <div id="main_content">
                    ...
                    echo form_open('tax_types/tax_types_manage',$form) ?>
                        <div class="row">
                            <div class="col-sm-12" id="user_list"><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                            <h4 class="panel-title"><?php echo $this->lang->line('tax_types') ?></h4>                                                                               
                                    </div>
                    ...
                    <div class="row">
                                <div class="col-lg-4"></div>
                                  <div class="col col-lg-4 text-center"><br><br>
                                      ...
                                      <a href="javascript:clear_add_tax_types()" name="clear" id="clear_user" class="btn btn-warning"><i class="icon icon-list"> </i> <?php echo $this->lang->line('clear') ?></a>
                                  </div>
                              </div>
                </div>
          </div>
...
<section id="edit_brand_form" class="container clearfix main_section">
     <?php   $form =array('id'=>'parsley_reg',
                          'runat'=>'server',
                          'class'=>'form-horizontal');
       echo form_open_multipart('tax_types/upadate_pos_tax_types_details/',$form);?>
        <div id="main_content_outer" class="clearfix">
           <div id="main_content">
                <div class="row">
                     <div class="col-lg-4"></div>
                   ...
                   <div class="row">
                        <div class="col-lg-4"></div>
                      <div class="col col-lg-4 text-center"><br><br>
                          <button id="update_tax_types"  type="submit" name="save" class="btn btn-success"><i class="icon icon-save"> </i> <?php echo $this->lang->line('update') ?></button>
