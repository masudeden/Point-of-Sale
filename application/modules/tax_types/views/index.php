    ...
    <div class="container">
            <div class="row">
                <div class="col col-lg-7">
                        <a href="javascript:posnic_add_new()" id="posnic_add_tax_types" class="btn btn-default" ><i class="icon icon-user"></i> <?php echo $this->lang->line('addnew') ?></a>  
                        ...
                        <a href="javascript:posnic_tax_types_lists()" class="btn btn-default" id="tax_types_lists"><i class="icon icon-list"></i> <?php echo $this->lang->line('tax_types') ?></a>
                </div>
            </div>
    </div>
</nav>
           ...
           <div id="main_content">
                <div class="row">
                   ...
                   <div class="row">
                        <div class="col-lg-4"></div>
                      <div class="col col-lg-4 text-center"><br><br>
                          <button id="update_tax_types"  type="submit" name="save" class="btn btn-default"><i class="icon icon-save"> </i> <?php echo $this->lang->line('update') ?></button>
