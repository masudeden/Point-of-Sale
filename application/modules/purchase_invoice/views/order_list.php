<?php
echo form_open('purchase_invoice/purchase_invoice_magement');
echo "<table>";
if($count>0){$i=0;
...
<a href="<?php echo base_url()?>index.php/purchase_invoice/edit_purchase_invoice/<?php echo $prow->guid ?>">Edit</a>
  <?php
   if($prow->active_status==1){?>
<a href="<?php echo base_url()?>index.php/purchase_invoice/restore_purchase_invoice/<?php echo $prow->guid ?>">
    <?php echo $this->lang->line('restore') ?></a> <?php } echo  "</td><td>"; ?>
<a href="<?php echo base_url()?>index.php/purchase_invoice/delete/<?php echo $prow->guid ?>">
