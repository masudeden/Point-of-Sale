...
?>
        ...
        function good_receiving_note_approve(guid,po){
            <?php if($this->session->userdata['supplier_payment_per']['approve']==1){ ?>
                $.ajax({
                url: '<?php echo base_url() ?>index.php/supplier_payment/good_receiving_note_approve',
                type: "POST",
                data: {
                    guid: guid,
                    po:po
        ...
        function posnic_active(guid){
                           $.ajax({
                url: '<?php echo base_url() ?>index.php/supplier_payment/active',
                type: "POST",
                data: {
                    guid: guid
                        ...
                        <?php if($this->session->userdata['supplier_payment_per']['edit']==1){ ?>
                            ...
                            $.ajax({                                      
                             ...
                             { 
                                ...
                                $("#parsley_reg #supplier_payment_guid").val(guid);
