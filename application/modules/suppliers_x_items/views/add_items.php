...
function copy_items(){
 ...
 if(document.getElementById('item_edit').value!='jibi'){
   ...
   // document.getElementById(od+"n").id=id+"n";
    ...
    $('<tr id='+item+'><td><input type=text name="coding[]" value='+code+' id='+item+'c class=item_inputd readonly=readonly ></td><td><input type=text name=dis[] value='+dis+' id='+item+'d class=item_input_d readonly=readonly ></td><td><input type=text name=quty[] value='+quty+' id='+item+'q class=item_input readonly=readonly ></td><td><input type=text name=cost[] value='+cost+' id='+item+'co class=item_input readonly=readonly ></td><td><input type=text name=sell[] value='+sell+' id='+item+'s class=item_input readonly=readonly ></td><td><input type=text name=mrp value='+disc+' id='+item+'p class=item_input ></td><td><select name=active[] ><option value=0 ><?php echo $this->lang->line('active')?></option><option value=1 ><?php echo $this->lang->line('deactive')?></option></select></td><td><input type=button name=item[] value=Edit id='+item+' onclick=edit_items_details(this.id)></td><td><input type=button value=x id='+item+' onclick= $(this).closest("tr").remove() ></td><td><input type=hidden name=items[] value='+item+' id='+item+'></td></tr>').fadeIn("slow").appendTo('#item_copy_final');
...
<td><select name="<?php echo $i_row->guid ?>"><option value="0" <?php if($it_row->item_active==0){ ?> selected="selected" <?php } ?>><?php echo $this->lang->line('active')?></option><option  value="1" <?php if($it_row->item_active==1){ ?> selected="selected" <?php } ?>><?php  echo $this->lang->line('deactive')?></option></select></td>
