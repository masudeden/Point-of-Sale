...
class Supplier extends CI_Model{
    ...
    function get($end,$start,$like,$branch){
                $this->db->select('suppliers.* ,suppliers_category.guid as c_guid,suppliers_category.category_name as c_name')->from('suppliers')->where('suppliers.branch_id',$branch)->where('suppliers.active_status',1)->where('suppliers.delete_status',1);
